...
public class StringUtils {
			...
			if (InitStripAccents.java6NormalizeMethod != null) {
				...
				throw new UnsupportedOperationException(
						"The stripAccents(CharSequence) method requires at least"
								+ " Java6, but got: "
								+ InitStripAccents.java6Exception
								+ "; or a Sun JVM: "
								+ InitStripAccents.sunException);
			}
	...
	private static String removeAccentsJava6(CharSequence text)
		 ...
		 */
		if (InitStripAccents.java6NormalizeMethod == null
				|| InitStripAccents.java6NormalizerFormNFD == null) {
			throw new IllegalStateException(
					"java.text.Normalizer is not available",
					InitStripAccents.java6Exception);
		}
		String result;
		result = (String) InitStripAccents.java6NormalizeMethod.invoke(null,
				new Object[] { text, InitStripAccents.java6NormalizerFormNFD });
	...
	private static String removeAccentsSUN(CharSequence text)
		...
		String result;
		result = (String) InitStripAccents.sunDecomposeMethod.invoke(null,
				new Object[] { text, Boolean.FALSE, Integer.valueOf(0) });
		...
		static {
			...
			try {
				...
				try {
					...
					_sunDecomposeMethod = normalizerClass.getMethod(
							"decompose",//$NON-NLS-1$
	 ...
	 */
	public static int ordinalIndexOf(CharSequence str, CharSequence searchStr,
			int ordinal) {
	...
	private static int ordinalIndexOf(CharSequence str, CharSequence searchStr,
	...
	public static int lastOrdinalIndexOf(CharSequence str,
			CharSequence searchStr, int ordinal) {
	 ...
	 *         {@code null}
	 */
	private static boolean endsWith(CharSequence str, CharSequence suffix,
			boolean ignoreCase) {

...
final class CameraConfigurationManager {
    ...
    private static Point getCameraResolution(Camera.Parameters parameters,
        ...
        Dbg.d("Scan","previewSizeValueString:"+previewSizeValueString+" cameraResolution:"+cameraResolution.x+"  "+cameraResolution.y);
        return cameraResolution;
    }
    ...
    private void setZoom(Camera.Parameters parameters) {
        ...
        if (maxZoomString != null) {
            try {
                ...
                Dbg.e("Bad max-zoom: " + maxZoomString);
            }
        }
        ...
        if (takingPictureZoomMaxString != null) {
            try {
            	...
            	Dbg.e("Bad taking-picture-zoom-max: " + takingPictureZoomMaxString);
            }
        }
